...
(function ($) {
    ...
    $.fn.extend({
        quick_update: function (options) {
            ...
            if (options.element_class) {
                options.element = options.element.replace('class="', 'class="' + options.element_class + ' ');
            }
            var form_html = '<form class="form-inline form-quick-update form-update-' + options.attribute + '">' +
